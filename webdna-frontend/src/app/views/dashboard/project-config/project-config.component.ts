...
export class ProjectConfigComponent implements OnInit {
    ...
    uploadedOptions = [
        new SimulationOption(ProjectFileType.UPLOADED_DAT, 'Configuration File', SimulationOptionType.FILE, null, null, (options) => {
            if (options[ProjectFileType.UPLOADED_DAT].value) {
                options['should_regenerate'].value = false;
            }
        }),
	 new SimulationOption(ProjectFileType.UPLOADED_TOP, 'Topography File', SimulationOptionType.FILE, null, null, (options) => {
            if (options[ProjectFileType.UPLOADED_TOP].value) {
                options['should_regenerate'].value = false;
            }
        }),
        new SimulationOption('box_size', 'Box Size', SimulationOptionType.INTEGER, null, 20),
    ...
    generationOptions = [
		...
		['uploaded', 'User Uploaded', this.uploadedOptions],
